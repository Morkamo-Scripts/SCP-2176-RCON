...
namespace SCP_2176_RCON.Items
{
    namespace SCP_2176_RCON.Items
    {
        ...
        public class RconA : Scp2176Rcon
        {
            public RconA()
            {
                Effects = new Dictionary<EffectType, EffectDetails>
                {
                    [EffectType.MovementBoost] = new EffectDetails(100, EffectsDuration),
                    [EffectType.Ghostly] = new EffectDetails(1, EffectsDuration),
                };
            }

            public override uint Id { get; set; } = 2;
            public override string Name { get; set; } = "SCP-2176-RCON-A";
            public override string Description { get; set; } = "";
            public override float Weight { get; set; } = 1f;
            public override SpawnProperties SpawnProperties { get; set; } = new SpawnProperties();
            public override ItemType Type => ItemType.SCP2176;
            public override Vector3 Scale => Vector3.one;
            public override Color LampColor { get; set; } = new Color32(50, 200, 40, 255);
            public override RconType CurrentType { get; } = RconType.RconA;
            ...
            public override void OnExplode2176Rcon(Projectile projectile, Vector3 position, Player player)
            {
                ...
                foreach (Player target in Player.List.Where(target => target.CurrentRoom == room))
                {
                    ...
                    DynamicTracing(target.GameObject, LampColor, EffectsDuration, TracerGlowIntensity, 2f, 0.01f);

                    // Обновление параметров "свойств игрока"
